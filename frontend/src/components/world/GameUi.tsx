                ...
                <div className="fixed bottom-8 right-8 z-20">
                    ...
                    >
                            <div className="relative h-6 w-6">
                                <div className="absolute left-1/2 top-0 h-2 w-px -translate-x-1/2 bg-current" />
                                <div className="absolute bottom-0 left-1/2 h-2 w-px -translate-x-1/2 bg-current" />

                                <div className="absolute left-0 top-1/2 h-px w-2 -translate-y-1/2 bg-current" />
                                <div className="absolute right-0 top-1/2 h-px w-2 -translate-y-1/2 bg-current" />
